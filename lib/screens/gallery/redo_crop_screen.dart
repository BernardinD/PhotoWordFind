...
class RedoCropScreen extends StatefulWidget {
  const RedoCropScreen(
      {super.key,
      required this.imageFile,
      this.initialAllowNameAgeUpdate,
      this.contact});
...
class _RedoCropScreenState extends State<RedoCropScreen> {
  ...
  Future<void> _captureCroppedArea() async {
    ...
    try {
      ...
      final cropLeft =
          (_cropRect.left - imageLeftOnScreen) / imageWidthOnScreen;
        ...
        children: [
          ...
          Positioned.fill(
            child: GestureDetector(
              ...
              child: CustomPaint(
                painter:
                    CropOverlayPainter(_cropRect, _isResizing, _resizeHandle),
                child: Container(),
              ),
            ),
          ),
                      ...
                      children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Switch(
                                    ...
                                    onChanged: (v) =>
                                        setState(() => _allowNameAgeUpdate = v),
                                  ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ElevatedButton.icon(
                              onPressed:
                                  _processing ? null : _captureCroppedArea,
