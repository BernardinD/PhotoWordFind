...
- Redesigned control bar layout keeps search at the top with filtering and sorting controls wrapping below so it scales smoothly when the screen height changes
